...
<div class="container">
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Nytt Event</button> <br>
...
<?php
try {
    $sql = "SELECT * FROM gora"; // Corrected table name
    ...
    if ($result->rowCount() > 0) {
        while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['event_namn']);?></td>
                <td><?php echo htmlspecialchars($row['plats']);?></td>
